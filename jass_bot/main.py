...
from agents.InformationSetMCTS import InformationSetMCTSOvercomplicated
...
if __name__ == "__main__":
    ...
    tournament_ABAB(lambda: InformationSetMCTSOvercomplicated(timebudget=0.02), AgentRandomSchieber, n_games=1)
